...
SELECT suppliers.CompanyName AS 'Fournisseurs', COUNT(products.UnitsOnOrder) AS 'Nbre produits'
FROM suppliers
INNER JOIN products
ON suppliers.SupplierID=products.SupplierID
WHERE suppliers.Country='France'
GROUP BY suppliers.CompanyName
ORDER BY COUNT(products.UnitsOnOrder) DESC

*/

/* Exercice 4

SELECT CompanyName AS 'Client', COUNT(OrderID) as 'Nbre de commandes'
FROM Customers
...
SELECT MONTH(orders.OrderDate) AS 'Mois 97', SUM(orderdetails.UnitPrice * orderdetails.Quantity) AS 'Montant des ventes'
FROM orderdetails
JOIN orders ON orderdetails.OrderID = orders.OrderID
WHERE year(orders.OrderDate) = 1997
